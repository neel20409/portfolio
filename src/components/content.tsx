  ...
  return (
    <div className="w-full flex flex-col justify-center items-start relative z-10 pointer-events-none">
      ...
      <motion.div 
        ...
        className="w-full p-5 sm:p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] bg-zinc-950/70 backdrop-blur-2xl border border-white/15 shadow-[0_20px_60px_rgba(0,0,0,0.8)] pointer-events-auto"
      >
        <AvatarPointer>
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/25 text-indigo-300 text-[10px] sm:text-xs font-mono font-semibold mb-3">
          ...
          <div className="min-h-[3.6rem] sm:min-h-[3.5rem] mt-3 sm:mt-4 flex items-center">
            <p className="text-gray-200 text-sm sm:text-xl md:text-2xl font-medium tracking-wide leading-snug">
              ...
              <span className="animate-pulse border-r-2 border-indigo-400 ml-1 inline-block h-4 sm:h-6 align-middle"></span>
            </p>
          </div>

          <div className="mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-2 text-[11px] sm:text-xs font-mono text-gray-400">
