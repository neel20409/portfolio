    ...
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          ...
          "flex max-w-fit fixed top-10 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-full dark:bg-black bg-white shadow-xl z-[5000] px-10 py-3 items-center justify-center space-x-8",
          className
        )}
      >
